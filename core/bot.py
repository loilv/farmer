...
class CandlePatternScannerBot:
    ...
    def _handle_multi_kline_order_queue(self):
        ...
        if abs(percentage_change) >= 5 and 180 < candle_duration > 240:
            if 85 < abs(precent_sell) <= 90 or 85 < abs(precent_buy) <= 90:
        ...
        # if abs(percentage_change) > 3 and 20 < candle_duration > 100:
